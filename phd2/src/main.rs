...
use phd2::{Phd2Connection, serialization::{Settle, ServerEvent, Event}};

#[tokio::main]
async fn main() {
    let mut phd2: Phd2Connection<_>= tokio::net::TcpStream::connect("astro.local:4400").await.expect("Connecting to phd2").into();
